...
import { setAttributes } from 'utils/svg'
...
export default function Greeting() {
  ...
  return (
    <div ref={wrapRef} className='h-[7.5rem] md:h-60 flex justify-center items-center  
      bg-amber-100 dark:bg-stone-600'
    >
      <svg width='100%' height='100%'>
        <text ref={textRef} x='50%' y='40%' textAnchor='middle' strokeDasharray='0 50%'
