...
export default function Landscape() {
  ...
  return (
    <div ref={wrapRef} className='h-full w-full relative transform-style-3d z-[-1]'
    >
      <svg xmlns='http://www.w3.org/2000/svg' className='h-full w-full translate-z-[-5px] scale-[6]'>
        <defs>
          <filter id='starsky'>
      ...
      <div className='h-full w-full absolute inset-0 opacity-0 dark:opacity-100
        transition-opacity delay-[2s] duration-1000 translate-z-[-5px] scale-[6]
        bg-[linear-gradient(rgba(0,11,22,0.1)40%,rgba(13,98,245,1)80%,rgba(57,167,255,1)100%)]'
      />
      <div className='h-full w-full absolute inset-0 bg-[length:100%_200%] bg-bottom 
        dark:bg-top dark:opacity-0 translate-z-[-5px] scale-[6]
