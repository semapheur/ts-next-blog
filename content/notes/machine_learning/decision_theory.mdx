...
$$
  \frac{\partial}{\partial x_1} \frac{1}{(2\pi)^{N/2}}e^{-\lVert\mathbf{x} - \boldsymbol{\theta}\rVert^2 / 2} = -\frac{x_1 -\theta_1}{(2\pi)^{N/2}}e^{-\lVert\mathbf{x} - \boldsymbol{\theta}\rVert^2 / 2}
$$
