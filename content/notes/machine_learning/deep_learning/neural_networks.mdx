...
<MathBox title='Scalar multiplication of fully connected feedforward neural networks' boxType='proposition' tag="proposition-15">
...
<MathBox title='Sum of fully connected feedforward neural networks' boxType='proposition' tag="proposition-16">
...
<MathBox title="Properties of modulus of continuity" boxType="proposition" tag="proposition-6">
...
<MathBox title="Properties of the linear interpolation operator" boxType="proposition" tag="proposition-7">
...
<MathBox title="Activation functions as fully-connected feedforward neural networks" boxType="proposition" tag="proposition-13">
...
<MathBox title="Compositions of fully-connected feedforward activation neural networks" boxType="proposition" tag="proposition-14">
...
<MathBox title="Representation for rectified linear unit feedforward neural network" boxType="lemma" tag="lemma-4">
...
<MathBox title="Rectified linear unit representation for linear interpolations" boxType="proposition" tag="proposition-16">
...
<MathBox title="Neural network approximations through linear interpolations" boxType="proposition" tag="proposition-17">
...
<MathBox title="Approximations through neural networks with constant realizations" boxType="proposition" tag="proposition-18">
...
<MathBox title="Explicit neural network approximations with prescribed error tolerances" boxType="corollary" tag="corollary-2">
For
- $\epsilon \in (0,\infty)$
- $a,b \in\R$ with $a < b$
...
<MathBox title="Explicit neural network approximations with prescribed error tolerances" boxType="corollary" tag="corollary-3">
Let
- $\epsilon\in (0,\infty)$
- $a,b\in\R$ with $a < b$
...
<MathBox title="Implicit one-dimensional neural network approximations (strong form)" boxType="corollary" tag="corollary-4">
...
<MathBox title="Implicit one-dimensional neural network approximations (weak form)" boxType="corollary" tag="corollary-5">
For $a,b\in\R$ with $a < b$ let $f:[a,b]\to\R$ be a Lipschitz continuous function with Lipschitz constant $L \in(0,\infty)$. Let $r:\R\to[0,\infty)$ denote the rectified linear unit. Then there exists $M \in\R$ such that for all $\epsilon \in (0, 1]$ there exists a fully-connected feedforward neural network $\boldsymbol{\Lambda}\in\mathcal{N}$ with the following properties.
