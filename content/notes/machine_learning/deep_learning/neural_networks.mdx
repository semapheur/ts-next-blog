...
<MathBox title='Sums of vectors as fully-connected feedforward neural networks' boxType="proposition" tag="10">
...
$$
- $\mathbf{A}_{\alpha, \beta} \in (\R \times \R) \subset \mathcal{N}$ denotes the one-dimension affine network with weight $\alpha$ and bias $\beta$
