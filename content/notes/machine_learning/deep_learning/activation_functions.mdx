...
The maxpool transformation $\operatorname{maxpool}:\R^n \to\R^m$ is defined as
...
The normalization transformation $\operatorname{normalize}:\R^n \to\R^n$ is defined as
