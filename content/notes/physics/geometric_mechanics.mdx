...
$$
\begin{align*}
  \frac{\mathrm{d}}{\mathrm{d}\theta} =& \frac{\mathrm{d}x}{\mathrm{d}\theta}\frac{\partial}{\partial x} + \frac{\mathrm{d}y}{\mathrm{d}\theta}\frac{\partial}{\partial y} + \frac{\mathrm{d}z}{\mathrm{d}\theta}\frac{\partial}{\partial z} \\
...
$$
\begin{align*}
  \frac{\mathrm{d}}{\mathrm{d}\phi} =& \frac{\mathrm{d}x}{\mathrm{d}\phi}\frac{\partial}{\partial x} + \frac{\mathrm{d}y}{\mathrm{d}\phi}\frac{\partial}{\partial y} + \frac{\mathrm{d}z}{\mathrm{d}\phi}\frac{\partial}{\partial z} \\
