...
\begin{align*}
  ...
  =& \sum_i \sum_j a_i^* a_j \braket{\phi_i | \phi_j} \\
  =& \sum_i \sum_j a_i^* a_j \delta_{ij} = \sum_i \left| a_i \right|^2
\end{align*}
$$
...
$$
  \frac{\partial P}{\partial t} = - \int_{S_\int^2} \mathbf{J}\cdot\d\mathbf{S}
$$
