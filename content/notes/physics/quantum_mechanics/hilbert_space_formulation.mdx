...
Consider a system of $n \in\N_+$ identical particles, each descreibed by the Hilbert space $\mathcal{H}^{(1)}$. The composite system is represented by the $n$-fold Hilbert space tensor product
