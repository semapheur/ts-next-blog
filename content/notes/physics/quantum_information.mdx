...
$$
\begin{align*}
  \operatorname{tr}\left((\hat{I}_A \otimes \hat{P}_B)\hat{U}(\hat{\rho}^A \otimes \hat{\rho}_B) \hat{U}^dagger \right) =& \operatorname{\tr}\left(\hat{U}(\hat{\rho}_A \otimes \hat{\rho}_B) \hat{U}^\dagger \right) \\
...
\begin{align*}
  ...
  =& \sum_{l=1}^m \braket{\ha{K}_l^\dagger \psi|\hat{\rho}|\hat{K}_l^\dagger \psi} \geq 0
\end{align*}
$$
...
$$
\begin{align*}
  \operatorname{tr}\left(\hat{K}(\hat{\rho})\right) =& \operatorname{tr}\left(\sum_{l=1}^m \hat{K}_l \hat{\rho} \hat{K}_ \right) = \sum_{l=1}^m \operatorname{tr}(\hat{K}_l \hat{\rho} \hat{K}_l^\dagger) \\
...
$$
  \sum_{l=1}^m \ha{K}_l^\dagger \hat{K}_l \leq \kappa\hat{I}
$$
...
$$
\begin{align*}
  &\operatorname{tr}\left((\ket{\psi}\bra{\psi} \otimes \sqrt{\hat{\rho}_B}) \hat{V}^\dagger \hat{V} (\ket{\psi}\bra{\psi} \otimes \sqrt{\hat{\rho}_B}) \right) \\
  =& \sum_{a,b} \Braket{e_a \otimes f_b|(\ket{\psi}\bra{\psi} \otimes\sqrt{\hat{\rho}_B})\hat{V}^\dagger \hat{V} (\ket{\psi}\bra{\psi}\otimes\sqrt{\hat{\rho}_B})|e_a \otimes f_b} \\
  =& \sum_{a,b} \Braket{(\ket{\psi}\bra{\psi} \otimes\sqrt{\hat{\rho}_B})^\dagger e_a \otimes f_b |\hat{V}^\dagger \hat{V} (\ket{\psi}\bra{\psi}\otimes\sqrt{\hat{\rho}_B})|e_a \otimes f_b} \\
  =& \sum_{a,b} \Braket{(\ket{\psi}\bra{\psi}^\dagger \otimes\sqrt{\hat{\rho}_B}^\dagger) e_a \otimes f_b |\hat{V}^\dagger \hat{V} (\ket{\psi}\bra{\psi}\otimes\sqrt{\hat{\rho}_B})|e_a \otimes f_b} \\
  =& \sum_{a,b} \Braket{(\ket{\psi}\bra{\psi} \otimes\sqrt{\hat{\rho}_B}) e_a \otimes f_b |\hat{V}^\dagger \hat{V} (\ket{\psi}\bra{\psi}\otimes\sqrt{\hat{\rho}_B})|e_a \otimes f_b} \\
  =& \sum_{a,b} \Braket{\ket{\psi}\braket{\psi|e_a} \otimes \sqrt{\hat{\rho}_B}\ket{f_b} |\hat{V}^\dagger \hat{V}| (\ket{\psi}\braket{\psi|e_a}\otimes\sqrt{\hat{\rho}_B}|f_b)} \\
  =& \sum_{a,b} |\braket{e_a|\psi}|^2 \Braket{\ket{\psi} \otimes \sqrt{\hat{\rho}_B}\ket{f_b} |\hat{V}^\dagger \hat{V}| (\ket{\psi}\otimes\sqrt{\hat{\rho}_B}|f_b)} \\
  \leq& \kappa \sum_{a,b} |\braket{e_a|\psi}|^2 \Braket{\ket{\psi} \otimes \sqrt{\hat{\rho}_B}\ket{f_b} | (\ket{\psi}\otimes\sqrt{\hat{\rho}_B}|f_b)} \\
...
\begin{align*}
  ...
  =& \sum_{b_1, b_2, b_3} \sum_{a_3, a_4} \left(\hat{V}(\hat{I}_A \otimes \sqrt{\hat{\rho}^B})\right)_{a_1 b_1, a_3 b_2} \boldsymbol{\rho}_{a_3 a_4}^{(A)} \delta{b_2, b_3} \left((\hat{I}_A \otimes \sqrt{\hat{\rho}^B})\hat{V}^\dagger\right)_{a_4 b_3, a_2 b_1} \\
...
\begin{align*}
  ...
  =& \sum_{b_1, b_2, a_3} \left((\hat{I}_A \otimes \sqrt{\hat{\rho}}_B)\hat{V}^\dagge \right)_{a_1 b_2, a_3 b_1} \left(\hat{V} (\hat{I}_A \otimes \sqrt{\hat{\rho}_B}) \right)_{a_3 b_1, a_2 b_2} \\
...
$$
  \hat{V}^\dagger \ha{V} \leq \kappa\hat{I}_{AB} \iff \sum_l \hat{K}_l^\dagger \hat{K}_l \leq \kappa\hat{I}_A
$$
