...
<MathBox title='Quantum gate' boxType='definition'>
...
| --- | --- | --- | --- |
| Identity | <img src="/fig/"/> | $\hat{I}$ | $$\begin{bmatrix} 1 & 0 \\ 0 & 1 \end{bmatrix}$$ |
| Phase-factor | <img src="/fig/"/> | $\hat{M}(\alpha) := e^{i\alpha}\hat{I}$ | $$\begin{bmatrix} e^{i\alpha} & 0 \\ 0 & e^{i\alpha} \end{bmatrix}$$ |
| Phase-shift | <img src="/fig/"/> | $\hat{P}(\alpha) := \ket{0}\bra{0} + e^{i\alpha}$ | $$\begin{bmatrix} 1 & 0 \\ 0 & e^{i\alpha} \end{bmatrix}$$ |
| Pauli-X or Q-NOT | <img src="/fig/"/> | $\hat{X} := \sigma_x$ | $$\begin{bmatrix} 0 & 1 \\ 1 & 0 \end{bmatrix}$$ |
| Pauli-Y | <img src="/fig/"/> | $\hat{Y} := \sigma_y$ | $$\begin{bmatrix} 0 & -i \\ i & 0 \end{bmatrix}$$ |
| Pauli-Z | <img src="/fig/"/> | $\hat{Z} := \sigma_z$ | $$\begin{bmatrix} 1 & 0 \\ 0 & -1 \end{bmatrix}$$ |
| Hadamard | <img src="/fig/"/> | $\hat{H} := \frac{\sigma_x + \sigma_z}{\sqrt{2}}$ | $$\frac{1}{\sqrt{2}}\begin{bmatrix} 1 & 1 \\ 1 & -1 \end{bmatrix}$$ |
</TableFigure>
