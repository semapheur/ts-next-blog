...
1. **Identity element:** The identity transformation $e = (0, 0, 0, \mathbf{I}_3)$ since it maps $(t, \mathbf{x}) \mapsto (t, \mathbf{x})$.
...
A closed path can be formed with successive Galilean transformations via

$$
\begin{align*}
  (\tau, \mathbf{a}, \mathbf{v}, \mathbf{R}) =& (\tau_2, \mathbf{a}_2, \mathbf{v}_2, \mathbf{R}_2)^{-1}(\tau_1, \mathbf{a}_1, \mathbf{v}_1, \mathbf{R}_1)^{-1} \\
  &\times (\tau_2, \mathbf{a}_2, \mathbf{v}_2, \mathbf{R}_2)(\tau_1, \mathbf{a}_1, \mathbf{v}_1, \mathbf{R}_1)
\end{align*}
$$

with resulting elements

$$
\begin{align*}
  \tau =& 0 \\
  \mathbf{a} =& -\mathbf{R}_2^{-1} [\mathbf{a}_2 + \mathbf{v}_2 \tau_2 + \mathbf{R}^{-1} (\mathbf{a}_1 - \mathbf{a}_2 - \mathbf{R}_2 \mathbf{a}_1 + \mathbf{v}_2 \tau_1 - \mathbf{v}_1 \tau_2) - \mathbf{v}_2 \tau_2] \\
  \mathbf{v} =& -\mathbf{R}_2^{-1} [\mathbf{v}_2 + \mathbf{R}_1^{-1} (\mathbf{v}_1 - \mathbf{v}_2 - \mathbf{R}_2 \mathbf{v}_1)] \\
  \mathbf{R} =& \mathbf{R}_2^{-1} \mathbf{R}_1^{-1} \mathbf{R}_2 \mathbf{R}_1
\end{align*}
$$
