...
The most general structure of $\hat{G}$ in $\eqref{equation-209}$ can be written as a linear combination of the corresponding generators
...
Any additive mulitple of the identity operator in $\hat{G}_j$ contributes only a phase factor to $\hat{U}_j$ and therefore cancels in the commutator $[\hat{G}_1, \hat{G}_2]$.
