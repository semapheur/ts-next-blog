...
$$
\begin{align*}
  \norm{\ket{\psi}}^2 =& \braket{\psi|\psi} = \int_{-\infty}^\infty \d\braket{\psi|\hat{P}_A (\lambda)|\psi} \\
...
$$
  \norm{(\hat{A} - \lambda_0) \ket{\psi(\epsilon)}}^2 = \int_{\lambda_0 - \epsilon}^{\lambda_0 + \epsilon} (\lambda - \lambda_0)^2 \;\d\norm{\hat{P}_A (\lambda) \ket{\psi(\epsilon)}}^2
$$

where the right-hand side is bounded above by

$$
  \epsilon^2 \int_{\lambda_0 - \epsilon}^{\lambda_0 + \epsilon} \d\norm{\hat{P}_A (\lambda) \ket{\psi(\epsilon)}}^2 = \epsilon^2 \int_{-\infty}^\infty \d\norm{\hat{P}_A (\lambda) \ket{\psi(\epsilon)}}^2 = \epsilon^2
$$
...
$$
\begin{equation*}
  \norm{(\hat{A} - \lambda_0) \ket{\psi(\epsilon)}} \leq \epsilon > 0
...
$$
  \lim_{\epsilon\to 0} \norm{(\hat{A} - \lambda_0) \ket{\psi(\epsilon)}} = 0
$$
...
$$
  \inf_{\ket{\psi}\in\mathcal{D}(\hat{A}),\;\norm{\ket{\psi}}=1} \norm{(\hat{A} - \lambda_0 \hat{I}) \ket{\psi}} = 0
$$
...
$$
  \norm{\ket{\phi(\epsilon)}} \leq \epsilon = \epsilon \norm{\hat{R}(\lambda; \hat{A}) \ket{\phi(\epsilon)}}
$$

which leads to

$$
  \frac{\norm{\hat{R}(\lambda; \hat{A}) \ket{\phi(\epsilon)}}}{\norm{\ket{\phi(\epsilon)}}} \geq \frac{1}{\epsilon}
$$
