...
<MathBox title="" boxType="proposition">
Let $\hat{A}$ be a self-adjoint operator on a Hilbert space $\mathcal{H}$, bounded from below. Then exactly one of the following two situations occurs:
