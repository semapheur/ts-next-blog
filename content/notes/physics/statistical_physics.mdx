...
Since the discretized Langevin dynamics defines a Markov process, the probability $\mathcal{P}_n (\mathbf{R})$ is fully determined in terms of the conditional probability $K(\mathbf{R}
|\mathbf{R})$ associated to the Markov step
