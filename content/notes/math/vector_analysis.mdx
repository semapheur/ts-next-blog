...
\begin{align*}
  ...
  \overset{\triangle}{\leq}& \lVert\mathbf{x}_n - \mathbf{x}\| +\rVert\mathbf{y}_n - \mathbf{y}_n| \\
...
\begin{align*}
  ...
  \overset{\triangle}{\leq}& \lVert \mathbf{y}\rVert + \lVert \mathbf{y}_n - \mathbf{y}\rVert \\
...
\begin{align*}
  ...
  \overset{\triangle}{\leq}& |Q(\mathbf{x})\lVert \mathbf{x} - \mathbf{a}\rVert| + |\nabla f(\mathbf{a})\cdot (\mathbf{x} - \mathbf{a})| \\
