...
Suppose $\mathbf{x}$ approaches $\mathbf{a}$ in the $x_i$-direction, i.e. $\mathbf{x} = \mathbf{a} + h\mathbf{e}_i$. Then $\mathbf{x} - \mathbf{a} = h\mathbf{e}_1$ and $\| \mathbf{x} - \mathbf{a} \| = |h|$. For the difference quotient to hold true then we require in both limits $h\downarrow 0$ and $h\uparrow 0$ that
...
$$
\begin{align*}
  \frac{|f(\mathbf{x}) - f(\mathbf{a}) - \D f(\mathbf{a})(\mathbf{x} - \mathbf{a})|}{\| \mathbf{x} - \mathbf{a} \|} =& \frac{|(\nabla f(\mathbf{c}) - \nabla f(\mathbf{a}))\cdot (\mathbf{x} - \mathbf{a})|}{\| \mathbf{x} - \mathbf{a} \|} \\
...
$$
\begin{align*}
  &\lim_{\mathbf{x}\to\mathbf{a}} \frac{|f(\mathbf{x}) - f(\mathbf{a}) - \D f(\mathbf{a})(\mathbf{x} - \mathbf{a})|}{\| \mathbf{x} - \mathbf{a} \|} \\
