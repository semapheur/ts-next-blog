...
For the second absolute term we note for some $n \geq N \in \N$ that $\Set{t(i)}_{i=1}^n \supset \left\{j}_{j=1}^{N_1 - 1}$. Thus, the series $\sum_{k=1}^{N_1 - 1} a_k$ vanishes altogether leaving
$$
