...
\begin{align*}
  &\varepsilon^I \wedge \varepsilon^J (\mathbf{e}_{p_1},\dots,\mathbf{e}_{p_{k+l}}) \\
  =& \frac{1}{k!l!} \sum_{\begin{subarray}{l} \tau\in S_k \\ \eta\in S_l \end{subarray}} \operatorname{sgn}(\tau)\operatorname{sgn}(\eta) \varepsilon^I (\mathbf{e}_{p}_{\sigma(1)},\dots,\mathbf{e}_{p_{\sigma(k)}})\varepsilon^J (\mathbf{e}_{p_{\sigma(k+1)}},\dots,\mathbf{e}_{p_{\sigma(k+l)}}) \\
