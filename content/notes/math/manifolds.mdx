...
<MathBox title='Properties of differentials' boxType='proposition' tag='proposition-38'>
...
Suppose $M$ is a smooth $n$-manifold without boundary, and let $(U,\varphi)$ be a smooth coordinate chart on $M$. Since $\varphi: U\to\tilde{U}\subseteq\R^n$ is a diffeomorphism onto its image, then by proposition $\ref{proposition-38}.4$  the differential 
