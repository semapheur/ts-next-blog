...
\begin{align*}
  ...
  =& \left.\frac{\partial}{\partial x^i}(\mathbf{p})
\end{align*}
$$
...
\begin{align*}
  ...
  (\alpha F)(\mathbf{v}_1,\dots,\mathbf{v}_k) =& \alpha (\mathbf{F}(\mathbf{v}_1,\dots,\mathbf{v}_k))
\end{align*}
$$
</MathBox>
...
$$
  F \otimes G: V_1\times\cdots\times V_k \timese W_1 \times\cdots\times W_l \to \R
$$
...
$$
  \omega^1 \otimes\cdots\omega^k (\mathbf{v}_1,\dots,\mathbf{v}_k) = \omeg^1 (\mathbf{v}_1)\cdots\omega^k (\mathbf{v}_k)
$$
</MathBox>
