...
<MathBox title='Smoothness criterion of a real-valued function' boxType='theorem'>
...
<MathBox title='Smooth maps between manifolds' boxType='theorem'>
...
<MathBox title='Smoothness criterion of a map between manifolds in terms of charts' boxType='proposition' tag='proposition-8'>
...
Since $F$ and $G$ are smooth, it follows by proposition $\ref{proposition-8}$**(1)**$\implies$**(3)** that $\sigma\circ G \circ\psi^{-1}$ and $\psi\circ F \circ\varphi^{-1}$ are smooth. As a composition of smooth maps of open subsets of Euclidean spaces, $\sigma\circ (G\circ F)\circ\varphi^{-1}$ is smooth. By proposition $\ref{\proposition-8}$**(3)**$\implies$**(1)**, it follows that $G\circ F$ is smooth.
