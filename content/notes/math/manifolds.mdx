...
A bijective bundle homomorphism $F:E\to E'$ whose inverse is also a bundle homomorphism, is called a *bundle isomorphism*. If $F$ is also a diffeormorphism, it is a *smooth bundle isomorphism*. If there exists a (smooth) bundle isomorphism between $E$ and $E'$, the two bundles *(smoothly) isomorphic*.
