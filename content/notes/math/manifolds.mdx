...
$$
  \Set{\left.\frac{\partial}{\partial x^i}\right\rvert_\mathbf{a} }_{i=1}^n,\quad \left.\frac{\partial}{\partial x^i}\right|_\mathbf{a} f = \frac{\partial f}{\partial x^i}(\mathbf{a})
$$

form a basis for $T_\mathbf{a} \R^n$, which there has dimension $n$
