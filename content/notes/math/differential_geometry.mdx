...
$$
  P_{t, t_0}^\gamma (a\mathbf{U}(t_0) + b\mathbf{W}(t_0)) = a P_{t, t_0}^\gamma (\mathbf{U}(t_0)) + b P_{t, t_0}^\gamma (b\mathbf{W}(t_0))
$$
...
for a vector field $\tilde{\mathbf{V}}(s) = \mathbf{V}(t - s)$ along $\tilde{\gamma}$. Since $\tilde{\mathbf{V}}(t - t_0)$ is parallel along $\tilde{\gamma}$ it follows that $0 \equiv \tilde{D}_t \tilde{\mathbf{V}}(t) = \tilde{D}_t (\mathbf{V}(t - s)$. Thus, $P_{t-t_0, 0}^{\tilde{\gamma}}$ is the inverse of $P_{t,t_0}^\gamma$.
</details>
</MathBox>
