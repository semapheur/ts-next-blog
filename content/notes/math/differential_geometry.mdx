...
<MathBox title='Covariant derivative of vector fields along curves' boxType='proposition'>
...
$$
  \mathbf{V}(t) = \sum_{i=1}^n V^i (t) \frac{\partial}{\partial x^i}
$$
...
\begin{equation}
\begin{split}
  \frac{\mathrm{D}}{\mathrm{d}t}(t_0) =& \sum_{i=1}^n \frac{\mathrm{D}}{\mathrm{d}t} (V^i(t) \frac{\partial}{\partial x^i}) \\
  =& \sum_{i=1}^n \frac{\mathrm{d}V^i}{\mathrm{d}t} \frac{\partial}{\partial x^i} + v^i \frac{\mathrm{D}}{\mathrm{d}t}\left(\frac{\partial}{\partial x^i} \right) \\
  =& \sum_{i=1}^n \dot{V}^i(t_0) \frac{\partial}{\partial x^i} + V^i \nabla_{\gamma'(t)} \frac{\partial}{\partial x^i} \\
  =& \sum_{i,j,k=1}^n \left(\dot{V}^k(t_0) + V^j(t_0) \dot{\gamma}^i(t_0) \Gamma_{ij}^k (\gamma(t_0)) \right)\frac{\partial}{\partial x^k}
