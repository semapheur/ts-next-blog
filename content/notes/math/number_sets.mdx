...
We write $[a]_n$ for the equivalence class of $a$ under this equivalence relation. For $m\in\N_+$, any integer is congruent mod $m$ to exactly one of the numbers $0,1,\dots,m-1$. The set of these equivalence relations is the quotient set
