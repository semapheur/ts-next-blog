...
$$
  \mathbb{Q} := \left(\Z \times \Z\backslash\Set{ [(a, b)]_\sim | (a, b) \in \Z \times \Z\backslash\Set{0} }
$$
...
$$
  \mathbb{Q} := \Set{ \frac{a}{b} \;|dle|\; a \in \Z,\; b \in \Z\backslash\Set{0} }
$$
...
$$
  \R := \mathcal{C}\backslash\sim := \Set{ \left[ \left(x_n \right)_{n\in\N} \right]_\sim |dle| \left(x_n \right)_{n\in\N} \in \mathcal{C} }
$$
...
The set of quaternions forms a 4-dimensional vector space over the real numbers with $\Set{1,\mathbf{i},\mathbf{j},\mathbf{k}}$ as basis. Thus quaternions satisfy componentwise addition
