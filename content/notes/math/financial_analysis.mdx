...
<MathBox title='Properties of $H$' boxType="proposition" tag="1">
...
<MathBox title='Optimal exit solution' boxType="theorem" tag="1">
...
<MathBox title='Optimal exit timing solution with stop-loss' boxType="theorem" tag="3">
...
<MathBox title='Properties of $\hat{H}$' boxType="proposition" tag="2">
...
<MathBox title='Optimal entry solution' boxType="theorem" tag="2">
...
<MathBox title='Properties of $\hat{H}_L$' boxType="proposition" tag="3">
