...
Interest rate is the relative return of risk-free securities and is usually paid at fixed intervals. If interest is paid accumulatively, it is called *compound*; otherwise it is called *simple*. Interest rate is usually stated on an annualized term either as a *nominal* or *effective* rate. Nominal interest rate (also called coupon rate) is the stated annual interest without accounting for compounding effects. Effective interest rate is the true interest rate accounting for compounding effects.
