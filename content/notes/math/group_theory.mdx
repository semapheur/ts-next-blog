...
$$
  (hg).m \underbrace{=}^{\eqref{equation-39}} h.(g.m) \underbrace{=}^{\eqref{equation-40}} = h.m \underbrace{=}^{\eqref{equation-40}} = h
$$
...
$$
\begin{equation*}
  m \underbrace{=}^{\eqref{equation-38}}& e.m \underbrace{=}^{\eqref{equation-15}} = (g^{-1} g).m \\
  \underbrace{=}^{\eqref{equation-39}}& g^{-1} .(g.m) \underbrace{=}^{\eqref{equation-40}} g^{-1} .m
\end{equation*}
$$
...
$$
\begin{align*}
  [g]_H \cdot ([g]_H)^{-1} \underbrace{=}^{\eqref{equation-33}}& [g]_H \cdot [g^{-1}]_H \underbrace{=}^{\eqref{equation-31}} \\
  \underbrace{=}^{\eqref{equation-8}}& [e]_H
\end{align*}
$$
...
$$
\begin{align*}
  [g_1]_{n\Z} +_{\Z/n\Z} [g_2]_{n\Z} \underbrace{=}^{\eqref{equation-37}}& [g_1 \bmod n]_{n\Z} +_{\Z/n\Z} [g_2 \bmod n]_{n\Z} \\
  \underbrace{=}^{\eqref{equation-31}}& [g_1 \bmod n + g_2 \bmod n]_{n\Z} \\
  \underbrace{=}^{\eqref{equation-37}}& [(g_1 \bmod n + +g_2 \bmod n) \bmod n]_{n\Z} \\
  =& [(g_1 + g_2) \bmod n]_{n\Z} \\
  \underbrace{=}^{\eqref{equation-16}}& [(g_1 +_{\Z_n} g_2)]_{n\Z} \tag{\label{equation-42}}
\end{align*}
$$
</MathBox>
...
$$
\begin{align*}
  \iota([g_1]_{n\Z} +_{\Z/n\Z} [g_2]_{n\Z}) \underbrace{=}^{\eqref{equation-42}}& \iota\left([(g_1 + g_2) \bmod n]_{n\Z}\right) \\
  \underbrace{=}^{\eqref{equation-43}}& (g_1 + g_2) \bmod n \\
  \underbrace{=}^{\eqref{equation-}}& g_1 \bmod n +_{\Z_n} g_2 \bmod n \\
  \underbrace{=}^{\eqref{equation-43}}& \iota([g_1]_{n\Z}) +_{\Z_n} \iota([g_2]_{n\Z})
\end{align*}
$$
...
$$
\begin{align*}
  \phi(e_1) \underbrace{=}^{\eqref{equation-8},\eqref{equation-7}}& \phi(e_1) \phi(g) (\phi(g))^{-1} \\
  \underbrace{=}^{\eqref{equation-41}}& \phi(e_1 g) (\phi(g))^{-1} \\
  \underbrace{=}^{\eqref{equation-15}}& \phi(g) (\phi(g))^{-1} \\
  \underbrace{=}^{\eqref{equation-8}}& e_2 \tag{\label{equation-44}}
\end{align*}
$$
...
$$
\begin{align*}
  \phi(h^{-1}) \underbrace{=}^{\eqref{equation-15}}& e_2 \phi(h^{-1}) \underbrace{=}^{\eqref{equation-45}} \phi(h) \phi(h^{-1}) \\
  \underbrace{=}^{\eqref{equation-41}}& \phi(hh^{-1}) \underbrace{=}^{\eqref{equation-8}} \\
  \underbrace{=}^{\eqref{equation-44}}& e_2
\end{align*}
$$

which shows that $h^{-1} \in\ker{\phi}$, verifying $\eqref{equation-}$.

Finally, for any $h_1, h_2 \ker{\phi}$

$$
  \phi(h_1 h_2) \underbrace{=}^{\eqref{equation-41}} \phi(h_1) \phi(h_2) \underbrace{=}^{\eqref{equation-45}} e_2 e_2 = e_2
$$

which shows that $h_1 h_2 \ker{\phi}$, verifying $\eqref{equation-}$.
...
$$
\begin{align*}
  \phi(h') =& \phi(ghg^{-1}) \underbrace{=}^{\eqref{equation-41}} \phi(g) \phi(h) \phi(g^{-1}) \\
  \underbrace{=}^{\eqref{equation-45}}& \phi(g) e_2 \phi(g^{-1}) = \phi(g)\phi(g^{-1}) \\
  \underbrace{=}^{\eqref{equation-41}}& \phi(gg^{-1}) = \phi(e_1) \\
  =& e_2
\end{align*}
$$
...
$$
\begin{align*}
  \phi(k) =& \phi(g^{-1} hg) \underbrace{=}^{\eqref{equation-41}} \phi(g^{-1}) \phi(h) \phi(g) \\
  \underbrace{=}^{\eqref{equation-45}}& \phi(g^{-1}) e_2 \phi(g) = \phi(g^{-1}) \phi(g) \\
  \underbrace{=}^{\eqref{equation-41}}& \phi(g^{-1} g) = \phi(e_1) \\
  =& e_2
\end{align*}
$$
...
$$
  h \underbrace{=}^{\eqref{equation-47}} gkg^{-1} \in\ker(\phi)^g
$$
