...
Let $G$ be an Abelian group. The group $\hat{G} := \operatorname{Hom}(G, \operatorname{U}(1))$ formed by its characters with the group operation in $\eqref{equation-}$ and $\eqref{equation-}$ is the *dual* or *character group* of $G$.
</MathBox>
