...
Moreover, for a prime $p$ the set $G \setminu\set{0} = \set{1,\dots,p-1}$ with group multiplication is given by
...
A group $G$ which can be generated from one element $g\in G$ such that

$$
  G = \braket{g}
$$

is called *cyclic* and in this case is called the *generator* of $G$.
</MathBox>
