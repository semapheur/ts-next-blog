...
$$
  \bar{p} = \frac{\d\bar{y}}{\d\bar{x}} = \frac{\d\bar{y}/\d x}{\d\bar{x}/\d x} = \frac{p + \epsilon\left(\frac{\partial \eta}{\partial x} + p\frac{\partial \eta}{\partial y} \right)}{1 + \epsilon\left(\frac{\partial \xi}{\partial x} + p\frac{\partial\xi}{\partial y} \right)} = p + \epsilon\left[\eta_x + \left(\eta_y - \eta_x \right)p - \xi_y p^2 \right] + \mathcal{O}(\epsilon^2)
$$
