...
$$
\begin{align}
  \sum_{k=0}^n \alpha_k(x) \frac{\mathrm{d}^k y}{\mathrm{d}x^k} &= \alpha_n(x) \frac{\mathrm{d}^n y}{\mathrm{d}x^n} + \alpha_{n-1}(x) \frac{\mathrm{d}^{n-1} y}{\mathrm{d}x^{n-1}} + \dots + \alpha_1 (x) \frac{\mathrm{d} y}{\mathrm{d}x} + \alpha_0 (x) y \\
  &= f(x)
\end{align}
$$
