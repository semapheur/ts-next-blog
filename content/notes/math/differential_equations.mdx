...
A system of ODEs has a vector functions $\mathbf{y}(x):\mathbb{R}\to\mathbb{R}^n$ as unknown. Its general form is
...
$$
  \mathcal{L}\left[ \mathbf{y}_H \right] = \mathbf{0} \implies \frac{\mathrm{d}\mathbf{y}_H}{\mathrm{d}t} = A \mathbf{y}_H
$$
