...
$$
  G\left(x, f(x), \frac{\mathrm{d}f}{\mathrm{d}x}, \dots, \frac{\mathrm{d}^n f}{\mathrm{d}x^n} \right) = 0
$$
...
$$
  \frac{\mathrm{d}^n f}{\mathrm{d}x^n} = F\left(x, f(x), \frac{\mathrm{d}f}{\mathrm{d}x}, \dots, \frac{\mathrm{d}^{n-1} f}{\mathrm{d}x^{n-1}} \right)
$$
...
$$
  \sum_{k=0}^n \alpha_k(x) \frac{\mathrm{d}^k y}{\mathrm{d}x^k} = \alpha_n(x) \frac{\mathrm{d}^n y}{\mathrm{d}x^n} + \alpha_{n-1}(x) \frac{\mathrm{d}^{n-1} y}{\mathrm{d}x^{n-1}} + \dots + \alpha_1 (x) \frac{\mathrm{d} y}{\mathrm{d}x} + \alpha_0 (x) y = f(x)
$$
...
The differential operator of order $n$ is defined as $\mathcal{D}^n[f] := \frac{\mathrm{d}^n}{\mathrm{d}x^n}f(x)$. It is a linear operator because it is closed under addition and scalar multiplication
...
where $\{ y_k(x) \}_{k=1}^n$ is a set of linearly independent solutions forming a basis for the solution vector space.

#### Linear independence

A set of vectors $\{ y_k(x) \}_{k=1}^n$ is linearly independent if the Wronskian, which is the determinant of the Wronskian matrix $W$, is non-zero

$$
  0 \neq W\left[ \{ y_k(x) \}_{k=1}^n \right] = \det W = \begin{vmatrix} 
    y_1 (x) & y_2 (x) & \dots & y_n (x) \\ 
    \frac{\mathrm{d}y_1}{\mathrm{d}x} (x) & \frac{\mathrm{d}y_2}{\mathrm{d}x} (x) & \dots & \frac{\mathrm{d}y_n}{\mathrm{d}x} (x) \\
    \vdots & \vdots & & \vdots \\
    \frac{\mathrm{d}^{n-1} y_1}{\mathrm{d}x^{n-1}}(x) & \frac{\mathrm{d}^{n-1} y_2}{\mathrm{d}x^{n-1}}(x) & \dots & \frac{\mathrm{d}^{n-1} y_n}{\mathrm{d}x^{n-1}}(x)
  \end{vmatrix}
$$
...
The resulting characteristic polynomial has $n$ roots. If all roots are distinct the solutions $\{e^{\lambda_k x} \}_{k=1}^n$ can be shown to be linear using the Wronskian

$$
\begin{align*}
  W\left[ \{e_k^{\lambda_k x} \}_{k=1}^n \right] &= e^{\sum_{k=1}^n \lambda_k x} \begin{vmatrix} 1 & 1 & \dots & 1 \\ \lambda_1 & \lambda_2 & \dots & \lambda_n \\ \vdots & \vdots & & \vdots \\ \lambda_1^{n-1} & \lambda_2^{n-1} & \dots & \lambda_n^{n-1} \end{vmatrix} \\
...
$$
  I(x) \left[ \frac{\mathrm{d}y}{\mathrm{d}x} + p(x)y \right] = \frac{\mathrm{d}\left[ I(x)y \right]}{\mathrm{d}x}
$$
...
$$
\begin{align*}
  \frac{\mathrm{d}\left[ I(x)y \right]}{\mathrm{d}x} &= I(x)q(x) \\
  \int \mathrm{d}\left[ I(x)y \right] &= \int q(x)I(x)\mathrm{d}x + c_1 \\
  y(x) &= \frac{1}{I(x)}\left[\int q(x)I(x)\mathrm{d}x + c_1 \right]
\end{align*}
$$
...
$$
\begin{align*}
  \frac{\mathrm{d}(Iy)}{\mathrm{d}x} &= I\frac{\mathrm{d}y}{\mathrm{d}x} + Ipy \\
  I\frac{\mathrm{d}y}{\mathrm{d}x} + y\frac{\mathrm{d}I}{\mathrm{d}x} &= I\frac{\mathrm{d}y}{\mathrm{d}x} + Ipy \\
  \int \frac{\mathrm{d} I}{I} &= \int p(x)\mathrm{d}x + c' \\
  \ln{I(x)} &= \int p(x)\mathrm{d}x + A \\
  I(x) &= Ae^{\int p(x)\mathrm{d}x}
\end{align*}
$$
...
$$
  y(x) = e^{-\int p(x)\mathrm{d}x} \left[ \int e^{-\int p(x)\mathrm{d}x} q(x) \mathrm{x} + c \right] \, , \quad c = \frac{c_1}{A}
$$
...
$$
\begin{gather*}
  \mathcal{L}[y] = \alpha_1 \frac{\mathrm{d}y}{\mathrm{d}x} + \alpha_0 y = f(x) \\
  \frac{\mathrm{d}y}{\mathrm{d}x} + \frac{\alpha_0}{\alpha_1} y = \frac{f(x)}{\alpha_1}
\end{gather*}
$$
...
$$
  \mathcal{L}[y] = \alpha_2 \frac{\mathrm{d}^2y}{\mathrm{d}x^2} + \alpha_1 \frac{\mathrm{d}y}{\mathrm{d}x} + \alpha_0 y
$$
...
This quadratic equation is called the characteristic equation of the ODE, with following roots
...
$$
\begin{gather*}
  \alpha_0 A y_1 + \alpha_1 \left( \frac{\mathrm{d}A}{\mathrm{d}x}y_1 + A  \frac{\mathrm{d}y_1}{\mathrm{d}x} \right) + \alpha_2 \left( \frac{\mathrm{d}^2 A}{\mathrm{d}x^2}y_1 + 2 \frac{\mathrm{d}A}{\mathrm{d}x} \frac{\mathrm{d}y_1}{\mathrm{d}x} + A \frac{\mathrm{d}^2 y}{\mathrm{d}x^2} \right) = 0 \\
  \alpha_0A e^{\lambda x} + \alpha_1 e^{\lambda x} \left( \frac{\mathrm{d}A}{\mathrm{d}x} + \lambda A \right) + \alpha_2 e^{\lambda x} \left(\frac{\mathrm{d}^2 A}{\mathrm{d}x^2} + 2\lambda \frac{\mathrm{d}A}{\mathrm{d}x} + A\lambda^2 \right) = 0 \\
  \frac{\alpha_1^2}{4 \alpha_2}A + \alpha_1 \left( \frac{\mathrm{d}A}{\mathrm{d}x} - \frac{\alpha_1}{2\alpha_2} A \right) + \alpha_2  \left(\frac{\mathrm{d}^2 A}{\mathrm{d}x^2} - \frac{\alpha_1}{\alpha_2} \frac{\mathrm{d}A}{\mathrm{d}x} + \frac{\alpha_1^2}{4\alpha_2^2} A \right) = 0 \\
...
A system of ODEs has a vector functions $\mathbf{y}(x): \mathbb{R} \mapsto \mathbb{R}^n$ as unknown. Its general form is

$$
\begin{gather*}
  G_1 \left(x, \mathbf{y}, \frac{\mathrm{d}\mathbf{y}}{\mathrm{d}x}, \dots \frac{\mathrm{d}^n\mathbf{y}}{\mathrm{d}x^n} \right) = 0 \\
  \vdots \\
  G_n \left(x, \mathbf{y}, \frac{\mathrm{d}\mathbf{y}}{\mathrm{d}x}, \dots \frac{\mathrm{d}^n\mathbf{y}}{\mathrm{d}x^n} \right) = 0
\end{gather*}
$$
...
$$
\begin{gather*}
  \frac{\mathrm{d}y_1}{\mathrm{d}x} = F_1\left(x, y_1, \dots, y_n \right) \\
  \vdots \\
  \frac{\mathrm{d}y_n}{\mathrm{d}x} = F_n\left(x, y_1, \dots, y_n \right)
\end{gather*}
$$
...
$$
\begin{gather*}
  \frac{\mathrm{d}y_1}{\mathrm{d}x} = \sum_{k=1}^n \alpha_{1k}y_k + g_1(t) \\
  \vdots \\
  \frac{\mathrm{d}y_n}{\mathrm{d}x} = \sum_{k=1}^n \alpha_{nk}y_k + g_n(t)
\end{gather*}
$$
...
\begin{gather*}
  ...
  \end{bmatrix} + \begin{bmatrix} 
    ...
    g_n (t) 
  \end{bmatrix} \\
  \frac{\mathrm{d}\mathbf{y}}{\mathrm{d}x} = A\mathbf{y} + \mathbf{g}(t)
\end{gather*}
$$

By defining the linear operator $\mathcal{L}[\mathbf{y}] = \left[\frac{\mathrm{d}}{\mathrm{d}t} - A \right]\mathbf{y}$, we can write the system of linear first order ODEs as
...
$$
  \mathcal{L}\left[ \mathbf{y_H} \right] = \mathbf{0} \implies \frac{\mathrm{d}\mathbf{y_H}}{\mathrm{d}t} = A \mathbf{y_H}
$$
...
$$
  V^{-1}\frac{\mathrm{d}\mathbf{y}}{\mathrm{d}t} = V^{-1} AVV^{-1} \mathbf{y}
$$

Letting $\mathbf{z} = V^{-1}\mathbf{y}$, we can write the system of ODEs as

$$
  \frac{\mathrm{d}\mathbf{z}}{\mathrm{d}t} = \Lambda \mathbf{z}
$$

The $i$th row of this equation reads $\frac{\mathrm{d}z_i}{\mathrm{d}t} = \lambda_i z_i$, giving $z_i = c_i e^{\lambda_1 t}$. Transforming back gives the homogenous solution
...
Letting $\mathbf{z} = W^{-1}\mathbf{z}$, we obtain $\frac{\mathrm{d}\mathbf{z}}{\mathrm{d}t} = J\mathbf{z}$ so that

$$
\begin{align*}
  \frac{\mathrm{d}z_n}{\mathrm{d}t} = \lambda z_n &\implies z_n = c_n e^{\lambda t} \\
  \frac{\mathrm{d}z_{n-1}}{\mathrm{d}t} = \lambda z_{n-1} + z_n &\implies z_{n-1} = c_{n-1}e^{\lambda t} + c_n t e^{\lambda t} \\
  &\vdots \\
  \frac{\mathrm{d}z_1}{\mathrm{d}t} = \lambda z_1 + z_2 &\implies z_1 = c_1 e^{\lambda t} + \dots + c_n \frac{t^{n-1}}{(n-1)!} e^{\lambda t}
\end{align*}
$$
...
The normalized eigenfunctions form an orthonormal basis under the $w$-weighted inner product in the Hilbert space $L^2\left([a,b], w(x) \mathrm{d}x\right)$, such that
...
Let $\mathbf{y}(0) = \alpha\mathbf{v}$ with $\alpha \in \mathbb{R}$, we have
...
$$
  \left.\frac{\mathrm{d}\mathbf{y}}{\mathrm{d}t}\right|_{\mathbf{y} = \mathbf{y}^*} = \mathbf{0}
$$
...
A fixed point $\mathbf{y}^*$ is said to be Lyapunov stable, if for every $\epsilon > 0$, there exists a $\delta > 0$ such that, if $\lVert \mathbf{y}(0) - \mathbf{y}^* \rVert < \delta$, then $\forall t \geq 0$ we have $\lVert \mathbf{y}(t) - \mathbf{y}^* \rVert < \epsilon$. Intuitively, it means the solution does not blow up, but does not necessarily approach to the fixed point.
</MathBox>

<MathBox title='Lyapunov stability' boxType='definition'>
A fixed point $\mathbf{y}^*$ is said to be asymptotically stable, if it is Lyapunov stable and there exists a $\delta > 0$ such that if $\lVert \mathbf{y}(0) - \mathbf{y}^* \rVert < \delta$, then

$$
  \lim_{t\to\infty} \lVert \mathbf{y}(t) - \mathbf{y}^* \rVert = 0
$$
</MathBox>

### 2D systems of linear ODEs

<LatexFig width={50} src='/fig/2d_linear_ode_phase_portrait.svg' alt=''
...
$$
  \frac{\mathrm{d}\mathbf{y}}{\mathrm{d}t} = A\mathbf{y} \, ,\quad A = \begin{bmatrix} a & b \\ c & d \end{bmatrix}
$$
...
$$
  y(x) = \int g(x) \mathrm{d}x + c = G(x) + c
$$
...
In this new coordinate system, the source term for the constraint equation is also independent of the dependent variable, ie. $\frac{\mathrm{d}S}{\mathrm{d}R} = f(R, T)$.
...
$$
\begin{align*}
  x \mapsto \bar{x}(\epsilon) &= x + \epsilon\xi(x, y) + \mathcal{O}(\epsilon^2) \quad& \bar{x}(\epsilon = 0) = x \\
  y \mapsto \bar{y}(\epsilon) &= y + \epsilon\eta(x, y) + \mathcal{O}(\epsilon^2) \quad& \bar{y}(\epsilon = 0) = y \\
  p \mapsto \bar{p}(\epsilon) &= p + \epsilon\zeta(x, y, p) + \mathcal{O}(\epsilon^2) \quad& \bar{p}(\epsilon = 0) = p
\end{align*}
$$
...
$$
  \bar{p} = \frac{\mathrm{d}\bar{y}}{\mathrm{d}\bar{x}} = \frac{\mathrm{d}\bar{y}/\mathrm{d}x}{\mathrm{d}\bar{x}/\mathrm{d}x} = \frac{p + \epsilon\left(\frac{\partial \eta}{\partial x} + p\frac{\partial \eta}{\partial y} \right)}{1 + \epsilon\left(\frac{\partial \xi}{\partial x} + p\frac{\partial\xi}{\partial y} \right)} = p + \epsilon\left[\eta_x + \left(\eta_y - \eta_x \right)p - \xi_y p^2 \right] + \mathcal{O}(\epsilon^2)
$$
...
$$
  F(\bar{x}, \bar{y}, \bar{p}) = e^{\epsilon X} F(x, y, p) = F(x, y, p) + \epsilon XF(x, y, p) + \mathcal{O}(\epsilon^2) = 0
$$
...
$$
  \frac{\mathrm{d}x}{\xi(x, y)} = \frac{\mathrm{d}y}{\eta(x, y)} = \frac{\mathrm{d}p}{\zeta(x, y, p)}
$$

In the new coordinate system there is a constraint equation

$$
  \frac{\mathrm{d}S}{\mathrm{d}R} = \frac{\mathrm{d}S/\mathrm{d}x}{\mathrm{d}R\mathrm{d}x} = \frac{S_x + S_y p}{R_x + R_y p}
$$

This derivative is independent of the group parameter $\epsilon$. Thus it is independent of $S$ and depends only on the invariant coordinates $R$ and $T$. In the canonical coordinates, the surface equations is $F(R, T) = 0$ and the constraint equation is $\frac{\mathrm{d}S}{\mathrm{d}R} = f(R, T)$.
...
$$
  S = \int f\left[R, T(R) \right] \mathrm{d}R + c
$$
...
$$
  D^{(n)} = \frac{\partial}{\partial x} + \sum_{i=0}^n \frac{\mathrm{d}y^{(n)}}{\mathrm{d}x}\frac{\partial}{\partial y^{(n)}}
$$
...
$$
  \frac{\mathrm{d}x}{\xi} = \frac{\mathrm{d}y}{\eta} = \frac{\mathrm{d}y^{(1)}}{\eta^{(1)}} = \dots = \frac{\mathrm{d}y^{(n)}}{\eta^{(n)}}
$$

In fact, only the first two invariant coordinates $R(x, y)$ and $T(x, y, y')$ need to be computed. The remaining invariant coordinates are given by $\frac{\mathrm{d}T^{(i)}}{\mathrm{d}R^{(i)}}$ for $i = 1, 2, \dots, n-1$. Each of these is of first degree in $y^{(i+1)}$. As a result, the existence of a Lie symmetry can be used to reduced an $n$th order equation to an $(n-1)$th order equation.
...
The Frobenius method allows power series soliutions $y = \sum_{n=0}^\infty a_n (x - x_0)^{n + r}$ for second-order ODEs of the form
...
$$
  m \frac{\mathrm{d}^2 x}{\mathrm{d}t^2} + b \frac{\mathrm{d}x}{\mathrm{d}t} + kx = F_0 \cos{\omega_0 t}
$$
...
$$
\begin{align*}
  m \frac{\mathrm{d}}{\mathrm{d} (t_s \tilde{t})} \left[ \frac{\mathrm{d} (x_s\tilde{x})}{\mathrm{d} (t_s \tilde{t})} \right] + b \frac{\mathrm{d} (x_s\tilde{x})}{\mathrm{d} (t_s \tilde{t})} + k(x_s \tilde{x}) &= F_0 \cos {\omega_0 t_s \tilde{t}} \\
  \frac{mx_s}{t_s^2} \frac{\mathrm{d}^2\tilde{x}}{\mathrm{d} \tilde{t}^2} + \frac{bx_s}{t_s} \frac{\mathrm{d}\tilde{x}}{\mathrm{d} \tilde{t}} + kx_s \tilde{x} &= F_0 \cos {\omega_0 t_s \tilde{t}}
\end{align*}
$$
...
$$
  \frac{\mathrm{d}^2\tilde{x}}{\mathrm{d} \tilde{t}^2} + \frac{bt_s}{m} \frac{\mathrm{d}\tilde{x}}{\mathrm{d}\tilde{t}} + \frac{kt_s^2}{m} \tilde{x} = \frac{F_0 t_s^2}{m x_s} \cos{\omega_0 t_s \tilde{t}}
$$
...
$$
\begin{align*}
  \frac{\mathrm{d}^2\tilde{x}}{\mathrm{d} \tilde{t}^2} + \frac{b}{\sqrt{mk}} \frac{\mathrm{d}\tilde{x}}{\mathrm{d} \tilde{t}} + \tilde{x} &= \cos{\left( \omega_0 \sqrt{\frac{m}{k}} \tilde{t} \right)} \\
  \frac{\mathrm{d}^2\tilde{x}}{\mathrm{d} \tilde{t}^2} + \alpha \frac{\mathrm{d}\tilde{x}}{\mathrm{d} \tilde{t}} + \tilde{x} &= \cos{\beta \tilde{t}}
\end{align*}
$$
...
\begin{gather*}
\begin{aligned*}
  (1 - x^2) \frac{\mathrm{d}^2y}{\mathrm{d}x^2} - 2x \frac{\mathrm{d}y}{\mathrm{d}x} + k(k + 1)y &= 0 \\
  \frac{\mathrm{d}^2y}{\mathrm{d}x^2} - \frac{2x}{(1 - x^2)} \frac{\mathrm{d}y}{\mathrm{d}x} + \frac{k(k + 1)}{(1 - x^2)}y &= 0
\end{aligned*} \\
  \frac{\mathrm{d}}{\mathrm{d}x} \left[\left(1 - x^2 \right) \frac{\mathrm{d}y}{\mathrm{d}x} \right] + k(k + 1)y = 0
\end{gather*}
$$
...
\begin{align*}
  ...
  \frac{\mathrm{d}y}{\mathrm{d}x} &= \sum_{n=0}^\infty na_n x^{n - 1} \\
  \frac{\mathrm{d}^2 y}{\mathrm{d}x^2} &= \sum_{n=0}^\infty n(n - 1)a_n x^{n - 2}
\end{align*}
$$
...
$$
  P_k (x) = \frac{1}{2^k k!} \frac{\mathrm{d}^k}{\mathrm{d}x^k} \left[ (x^2 - 1)^k \right]
$$
...
$$
\begin{align*}
  P_k (x) &= \frac{1}{2^k k!} \frac{\mathrm{d}^k}{\mathrm{d}x^k} \sum_{i=0}^k \frac{k!}{i!(k-i)!}\left( x^2 \right)^{k-i} (-1)^i \\
  &= \frac{1}{2^k k!} \sum_{i=0}^k \frac{k!}{i!(k-i)!} (-1)^i \frac{\mathrm{d}^k}{\mathrm{d}x^k} \left[ \left( x^2 \right)^{k-i} \right] \\
  &= \frac{1}{2^k k!} \sum_{i=0}^k \frac{k!}{i!(k-i)!} (-1)^i \frac{\mathrm{d}^k}{\mathrm{d}x^k} \left[ \left( x^2 \right)^{k - i} \right] 
\end{align*}
$$

We have $\frac{\mathrm{d}^n}{\mathrm{d}x^n} \left(x^r \right) = \frac{r!}{(r-n)!} x^{r - n}$
...
$$
  \frac{\mathrm{d}y}{\mathrm{d}x} = a(x) + b(x)y + c(t)y^2
$$
...
$$
\begin{align*}
  y &= -\frac{1}{cu} \frac{\mathrm{d}u}{\mathrm{d}x} = -\frac{1}{c} \frac{\mathrm{d}}{\mathrm{d}x} (\ln{u}) \\
  \frac{\mathrm{d}y}{\mathrm{d}x} &= -\frac{1}{cu} \frac{\mathrm{d}^2u}{\mathrm{d}x^2} - \frac{1}{u}\frac{\mathrm{d}u}{\mathrm{d}x}\frac{\mathrm{d}}{\mathrm{d}x}\left( \frac{1}{c} \right) - \frac{1}{c} \frac{\mathrm{d}u}{\mathrm{d}t}\frac{\mathrm{d}}{\mathrm{d}t}\left( \frac{1}{u} \right) \\
  &= -\frac{1}{cu} \frac{\mathrm{d}^2u}{\mathrm{d}x^2} + \frac{1}{u}\frac{\mathrm{d}u}{\mathrm{d}x}\frac{1}{c^2}\frac{\mathrm{d}c}{\mathrm{d}x} + \frac{1}{c}\frac{\mathrm{d}u}{\mathrm{d}x}\frac{1}{u^2}\frac{\mathrm{d}u}{\mathrm{d}x} \\
  &= -\frac{1}{cu} \frac{\mathrm{d}^2u}{\mathrm{d}x^2} + \frac{1}{uc^2}\frac{\mathrm{d}c}{\mathrm{d}x}\frac{\mathrm{d}u}{\mathrm{d}x} + \frac{1}{cu^2}\left(\frac{\mathrm{d}u}{\mathrm{d}x}\right)^2
\end{align*}
$$
...
$$
\begin{gather*}
  -\frac{1}{cu} \frac{\mathrm{d}^2u}{\mathrm{d}x^2} + \frac{1}{uc^2}\frac{\mathrm{d}c}{\mathrm{d}x}\frac{\mathrm{d}u}{\mathrm{d}x} + \frac{1}{cu^2}\left(\frac{\mathrm{d}u}{\mathrm{d}x}\right)^2 = a - b \frac{1}{cu} \frac{\mathrm{d}u}{\mathrm{d}x} + c \left(-\frac{1}{cu} \frac{\mathrm{d}u}{\mathrm{d}x} \right)^2 \\
  -\frac{\mathrm{d}^2u}{\mathrm{d}x^2} + \frac{1}{c}\frac{\mathrm{d}c}{\mathrm{d}x}\frac{\mathrm{d}u}{\mathrm{d}x} = acu - b\frac{\mathrm{d}u}{\mathrm{d}x} \\
  \frac{\mathrm{d}^2u}{\mathrm{d}x^2} - \left( \frac{1}{c}\frac{\mathrm{d}c}{\mathrm{d}x} + b \right)\frac{\mathrm{d}u}{\mathrm{d}x} + acu = 0
\end{gather*}
$$
...
$$
  \frac{\mathrm{d}^2u}{\mathrm{d}x^2} - b \frac{\mathrm{d}u}{\mathrm{d}x} + acu = 0
$$
...
\begin{align*}
  ...
  \frac{\mathrm{d}u}{\mathrm{d}x} &= C_1 \frac{b + R}{2} e^{\frac{b + R}{2}x} + C_2 \frac{b - R}{2} e^{\frac{b - R}{2}x}
\end{align*}
$$
...
$$
\begin{align*}
  y(x) &= -\frac{1}{cu} \frac{\mathrm{d}u}{\mathrm{d}x} \\
