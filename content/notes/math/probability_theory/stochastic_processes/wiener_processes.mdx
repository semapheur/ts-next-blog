...
In terms of oder of the moment, the dominant term inside the exponential is $\sigma^2 n^2 /2$. If $n > 1 - 2\mu/s\sigma^2$ then $n\mu + \sigma^2 (n^2 - n)/2 > 0$ so $\lim_{t\to\infty} \mathbb{E}(X_t) \eqas \infty$.
