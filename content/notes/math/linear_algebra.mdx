...
- $\mathbf{Cartan}(\mathbf{A} + \mathbf{B}) = \mathbf{C}\mathbf{A} + \mathbf{C}\mathbf{B}$ **(left distributivity)**
...
A matrix $\mathbf{R}$ is said to be in *reduced row echelon* form if
...
$$
  \mathbf{D}_i (m) = \mathbf{T}_{i,j} = \begin{bmatrix}
    1 & & & & & & \\
    & \ddots & & & & & \\
    & & 1 & & & & \\
    & & & m & & & \\
...
$$
  \mathbf{L_h}_{i,j} (m) = \mathbf{T}_{i,j} = \begin{bmatrix}
    1 & & & & & & \\
    & \ddots & & & & & \\
    & & 1 & & & & \\
    & & & \ddots & & & \\
...
The entries of $\mathbf{L}_{i,j}(m)$ are given by

$$
  [\mathbf{L}_{i,j}(m)]_{k,l} = \begin{cases} 
    0 \quad& k\neq l, k\neq i, l\neq j \\
    1 \quad& k = l \\
    m \quad& k = i, l = j
  \end{cases}
