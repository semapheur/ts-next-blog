...
<LatexFigure width={50} src='/fig/category.svg' alt=''
...
<LatexFigure width={50} src='/fig/isomorphism.svg' alt=''
...
<LatexFigure width={25} src='/fig/natural_transformation.svg' alt=''
...
<LatexFigure width={50} src='/fig/universal_property.svg' alt=''
