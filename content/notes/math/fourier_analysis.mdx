...
Since $f$ is piecewise $C^1$, it follows that $\tilde{f}$ is a piecewise continuous function in $L_{2\pi}^2 (\R, \mathbb{C})$. By Parseval's identity (Theorem $\ref{theorem-}$), we have
