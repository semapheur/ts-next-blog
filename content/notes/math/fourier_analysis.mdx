...
$$
	\| f \|_{L^2}^2 = \int_{-\infty}^\infty |f(x)|^2\;\mathrm{d}x = \int_{-\infty}^\infty \left|\hat{f}(\xi)\right|^2\;\mathrm{d}\xi
$$
</MathBox>
...
$$
\begin{align*}
	\| f \|_{L^2}^2 &= \int_{-\infty}^\infty |f(x)|^2\;\mathrm{d}x = \int_{-\infty}^\infty f(x)\overline{f(x)}\;\mathrm{d}x \\
...
$$
\begin{align*}
	\| g \|_{L^2}^2 &= \int_{-\infty}^\infty \left| e^{-i2\pi\xi_0 x} f(x + x_0) \right|^2 \;\mathrm{d}x = \int_{-\infty}^\infty \left| f(t) \right|^2 \;\mathrm{d}t = \| f \|_{L^2}^2 \\
	\| u g(u) \|_{L^2} &= \left( \int_{-\infty}^\infty \left| u e^{-i2\pi\xi_0 u} f(u + x_0) \right|^2 \;\mathrm{d}u \right)^{1/2} \\
	&= \left( \int_{-\infty}^\infty \left| (x - x_0) f(x) \right|^2 \;\mathrm{d}x \right)^{1/2} = \| (x - x_0)f(x) \|_{L^2} \\
	\| t\hat{g}(t) \|_{L^2} &= \left( \int_{-\infty}^\infty \left| t e^{i2\pi x_0 t} \hat{f}(t + \xi_0) \right|^2 \;\mathrm{d}t \right)^{1/2} \\
	&= \left( \int_{-\infty}^\infty \left| \left(\xi - \xi_0 \right) \hat{f}(\xi_0) \right|^2 \;\mathrm{d}\xi \right)^{1/2} = \left\| \left(\xi - \xi_0\right) \hat{f}(\xi) \right\|_{L^2}
\end{align*}
$$
...
$$
	f(t) = \mathcal{F}^{-1}\left[ \hat{f}_g (t, \omega) \right] = \frac{1}{2\pi\| g\|^2} \int_{-\infty}^\infty\int_{-\infty}^\infty \hat{f}_g (\tau, \omega)g(t - \tau)e^{i\omega t}\;\mathrm{d}\omega \mathrm{d}t
$$
</MathBox>
