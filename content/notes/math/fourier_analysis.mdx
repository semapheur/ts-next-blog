...
$$
\begin{align*}
	\mathcal{S}\left(\mathbb{R}^n, \mathbb{C}\right) &:= \left\{ f\in C^\infty (\mathbb{R}^n, \mathbb{C}) \;|\; \forall \alpha, \beta \in \mathbb{N}^n \;: \lVert f \rVert_{\alpha, \beta} < \infty \right\} \subset L^1\left(\mathbb{R}^n, \mathbb{C}\right) \\
...
$$
	\left\{\psi_{a,b}(t) = \frac{1}{\sqrt{a}}\left( \frac{t - b}{a} \right) \mid| b \in\mathbb{R},\; a\mathbb{R}^+ \right\}
$$
