...
$$
  I[y] = \int_{x_1}^{x_2} L\left(x, y, \frac{\mathrm{d}y}{\mathrm{d}x} \right) \mathrm{d}x
$$
...
$$
\begin{align*}
  0 &= \left. \frac{\mathrm{d}\Phi}{\mathrm{d}\varepsilon} \right|_{\varepsilon = 0} \\
  &= \left. \frac{\mathrm{d}}{\mathrm{d}\varepsilon} \right|_{\varepsilon = 0} \int_{x_1}^{x_2} L\left(x, \bar{f}, \bar{f}' \right) \mathrm{d}x \\
  &= \left. \int_{x_1}^{x_2} \frac{\mathrm{d}}{\mathrm{d}\varepsilon} L\left(x, \bar{f}, \bar{f}' \right) \mathrm{d}x \right|_{\varepsilon = 0} \\
  &= \left. \int_{x_1}^{x_2} \left( \frac{\partial L}{\partial \bar{f}} \frac{\partial \bar{f}}{\partial \varepsilon} + \frac{\partial L}{\partial \bar{f}'}\frac{\partial \bar{f}'}{\partial \varepsilon} \right) \right|_{\varepsilon = 0} \mathrm{d}x \\
  &= \left. \int_{x_1}^{x_2} \left( \frac{\partial L}{\partial \bar{f}} \eta + \frac{\partial L}{\partial \bar{f}'}\eta' \right) \right|_{\varepsilon = 0} \mathrm{d}x
\end{align*}
$$
...
$$
  \int_{x_1}^{x^2} \frac{\partial L}{\partial \bar{f}'}\eta' \mathrm{d}x = \frac{\partial L}{\partial \bar{f}'} \underbrace{\left[ \eta \right]_{x_1}^{x_2}}_{=0} - \int_{x_1}^{x^2} \eta \frac{\mathrm{d}}{\mathrm{d}x} \left( \frac{\partial L}{\partial \bar{f}'} \right) \mathrm{d}x
$$
...
$$
\begin{align*}
  0 &= \left. \int_{x_1}^{x_2} \left[ \frac{\partial L}{\partial \bar{f}} \eta - \frac{\mathrm{d}}{\mathrm{d}x} \left( \frac{\partial L}{\partial \bar{f}'} \right) \eta \right] \right|_{\varepsilon = 0} \mathrm{d}x \\
  &= \int_{x_1}^{x_2} \left[ \frac{\partial L}{\partial f} - \frac{\mathrm{d}}{\mathrm{d}x} \left( \frac{\partial L}{\partial f'} \right) \right] \eta \mathrm{d}x 
\end{align*}
$$
...
\begin{align*}
  \frac{\partial L}{\partial f} - \frac{\mathrm{d}}{\mathrm{d}x} \left( \frac{\partial L}{\partial f'} \right) = 0 \\
  y' \frac{\partial L}{\partial f} - y' \frac{\mathrm{d}}{\mathrm{d}x} \left( \frac{\partial L}{\partial f'} \right)
\end{align*}
$$

The term $y' \frac{\partial L}{\partial y}$ is also found in the total derivative $\frac{\mathrm{d}L(x, y, y')}{\mathrm{d}x}$

$$
\begin{gather*}
  \frac{\mathrm{d}L}{\mathrm{d}x} = \frac{\partial L}{\partial x} + \frac{\partial L}{\partial y}y' + \frac{\partial L}{\partial y'}y'' \\
  y' \frac{\partial L}{\partial y} = \frac{\mathrm{d}L}{\mathrm{d}x} - \frac{\partial L}{\partial x} - \frac{\partial L}{\partial y'}y''
\end{gather*}
$$
...
$$
\begin{gather*}
  \frac{\mathrm{d}L}{\mathrm{d}x} - \frac{\partial L}{\partial x} - \left[ \frac{\partial L}{\partial y'}y'' - y' \frac{\mathrm{d}}{\mathrm{d}x} \left( \frac{\partial L}{\partial f'} \right) \right] = 0 \\
  \frac{\mathrm{d}L}{\mathrm{d}x} - \frac{\partial L}{\partial x} - \frac{\mathrm{d}}{\mathrm{d}x} \left( y' \frac{\partial L}{\partial y'} \right) = 0 \\
  \frac{\mathrm{d}}{\mathrm{d}x} \left( L - y' \frac{\partial L}{\partial y'} \right) = \underbrace{\frac{\partial L}{\partial x}}_{=0} \\
...
$$
  T = \int_a^b \mathrm{d}t = \int_a^b \frac{\mathrm{d}S}{v(x, y)}
$$

where
- the infinitisemal distance $\mathrm{d}S$ is retrieved from the Pythagorean theorem: $\sqrt{1 + \left(\frac{\mathrm{d}y}{\mathrm{d}x}\right)^2}\mathrm{d}x$
...
$$
  T = \int_a^b \sqrt{\frac{1 + (y')^2}{2g(h-y)}} \mathrm{d}x
$$
...
\begin{gather*}
  ...
  \frac{\mathrm{d}y}{\mathrm{d}x} = \sqrt{\frac{C_1 - (h - y)}{h - y}}
\end{gather*}
$$
...
$$
\begin{align*}
  \mathrm{d}x &= \sqrt{\frac{C_1 - (h - y)}{h - y}} \mathrm{d}y \\
  x &= \int \sqrt{\frac{C_1 - (h - y)}{h - y}} \mathrm{d}y
\end{align*}
$$
...
\begin{gather*}
  ...
  \mathrm{d}y = - C_1 \sin\left( \frac{\theta}{2} \right)\cos\left( \frac{\theta}{2} \right) \mathrm{d}\theta
\end{gather*}
$$
...
$$
\begin{align*}
  x &= -C_1 \int \sqrt{\frac{C_1 \sin^2 \left( \frac{\theta}{2} \right)}{C_1 \left[1 - \sin^2 \left( \frac{\theta}{2} \right) \right]}}  \sin\left( \frac{\theta}{2} \right)\cos\left( \frac{\theta}{2} \right) \mathrm{d}\theta \\
  &= -C_1 \int \sin^2 \left( \frac{\theta}{2} \right) \mathrm{d}\theta \\
  &= -\frac{C_1}{2} \int (1 - \cos\theta)\mathrm{d}\theta \\
...
The Langrange multiplier method finds extrema of a function $f: \mathbb{R}^n \to \mathbb{R}$ subject to $k$ equality constraints $g_i(\mathbf{x}) = c_i$ where $g_i : \mathbb{R}^n \to \mathbb{R}$.
