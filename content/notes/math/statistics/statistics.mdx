...
with covariance and correlation
1. $\operatorname{cov}[W^2 (\mathbf{X}), W^2 (\mathbf{Y})] = (\delta_2 - \sigma^2 \tau^2)/n$
2. $\operatorname{cor}[W^2 (\mathbf{X}), W^2 (\mathbf{Y})] = (\delta_2 - \sigma^2 \tau^2)/\sqrt{(\mu_4 - \sigma^4)(\nu_4 - \tau^4)}$
...
with covariance and correlation
1. $\operatorname{cov}[S^2 (\mathbf{X}), S^2 (\mathbf{Y})] = (\delta_2 - \sigma^2 \tau^2)/n + 2\delta^2 /[n(n-1)]$
2. $\operatorname{cor}[S^2 (\mathbf{X}), S^2 (\mathbf{Y})] = [(n-1)(\delta_2 - \sigma^2 \tau^2) + 2\delta^2]/\sqrt{[(n-1)\mu_4 - (n-3)\mu_4][(n-1)\nu_4 - (n-3)\nu_4]}$
