...
<MathBox title='Affine space' boxType="definition" tag="1">
...
<MathBox title='Properties of affine space action' boxType="proposition" tag="1">
...
<MathBox title='Affine independence criterion' boxType="proposition" tag="3">
