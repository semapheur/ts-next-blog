...
$$
  \hat{\boldsymbol{boldsymbol}}_{\mathrm{MLE}} = \argmax_{\boldsymbol{\theta}\in\Theta} L_{\boldsymbol{x}} (\boldsymbol{\theta}) = \argmax_{\boldsymbol{\theta}\in\Theta} \ell_{\boldsymbol{x}} (\boldsymbol{\theta})
$$

Intuitively, the maximum likelihood estimation$\hat{\boldsymbol{boldsymbol}}_{\mathrm{MLE}}$ is the parameter that would have most likely produced the observed data. 
</MathBox>
